...
class ContactTableViewController: UITableViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        //Copied from assignmet instructions.
    ...
    //Mine did not have this so it was copied from the assignment instructions.
    ...
    {
        //Copied from instructions.if editingStyle == .delete {
